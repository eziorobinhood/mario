...
cactus_img = pygame.image.load(r'C:\Users\IT LAB\mu_code\images\cactus_bricks.png')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load(r'C:\Users\IT LAB\mu_code\images\fire_bricks.png')
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load(r'C:\Users\IT LAB\mu_code\images\dragon.png')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load(r'C:\Users\IT LAB\mu_code\images\fireball.png')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load(r'C:\Users\IT LAB\mu_code\images\maryo.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound(r'C:\Users\IT LAB\mu_code\music\mario_dies.wav')
    music.play()
    topscore.top_score(SCORE)
    game_over_img = pygame.image.load(r'C:\Users\IT LAB\mu_code\images\end.png')
...
def start_game():
    canvas.fill(BLACK)
    start_img = pygame.image.load(r'C:\Users\IT LAB\mu_code\images\start.png')
...
def game_loop():
    while True:
        ...
        global  HIGH_SCORE
        flames_list = []
        pygame.mixer.music.load(r'C:\Users\IT LAB\mu_code\music\mario_theme.wav')
